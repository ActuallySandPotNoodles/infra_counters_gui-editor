...
import json, sandstuff, vdf, os, metadata_builder
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout.addWidget(self.label_7, 0, 3, 2, 2)
        ...
        self.gridLayout.addWidget(self.cams, 2, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.corrupt, 3, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.repair, 4, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.mistakes, 5, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.geocaches, 6, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.apply, 11, 3, 1, 2)
        self.treeWidget = QtWidgets.QTreeWidget(parent=Form)
        self.treeWidget.setObjectName("treeWidget")
        item_0 = QtWidgets.QTreeWidgetItem(self.treeWidget)
        self.gridLayout.addWidget(self.treeWidget, 2, 0, 9, 3)
        ...
        self.pushButton.clicked.connect(self.build_thing)
    ...
    def build_thing(self):
        loc, ok = QtWidgets.QFileDialog.getSaveFileName(Form, "Export file", "metadata.h")
        if loc:
            sandstuff.tee(loc, metadata_builder.build(self.mapdata))
    ...
    def retranslateUi(self, Form):
        ...
        self.label_8.setText(_translate("Form", "INFRA Counters Mod Mapdata Editor - Version 1.0 - Made by SandPotNoodles"))
        self.pushButton.setText("Export metadata.h")
